                ...
                <div className="flex grid items-center lg:grid-cols-2">
                    <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
                        <div
                            ...
                            <h2 className="mb-16 text-3xl font-bold font-technorbold text-white">
                                Trusted by the top projects <br />
                                <span className="">on Solana</span>
                            </h2>
                    ...
                    <div className="md:mb-12 lg:mb-0">
                        <img src="https://i.imgur.com/K7otSQ0.jpg"
